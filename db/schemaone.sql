...
CREATE DATABASE IF NOT EXISTS route_optimizer1;
USE route_optimizer1;
...
CREATE TABLE IF NOT EXISTS delivery_partners1 (
  id INT AUTO_INCREMENT PRIMARY KEY,
  user_id INT,
  name VARCHAR(100) NOT NULL,
  email VARCHAR(100) NOT NULL,
  phone VARCHAR(20) NOT NULL,
  vehicle_type ENUM('car', 'bike', 'truck', 'walk') NOT NULL,
  capacity DECIMAL(10,2) NOT NULL, -- in kg
  status ENUM('active', 'inactive', 'on-delivery') NOT NULL DEFAULT 'active',
